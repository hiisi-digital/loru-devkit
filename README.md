...
deno run -A https://raw.githubusercontent.com/hiisi-digital/loru-devkit/v0.3.3/deno/fetch_schema.ts \
  --schema=loru-config \
  --meta-file=loru.toml \
...
```bash
deno run -A https://raw.githubusercontent.com/hiisi-digital/loru-devkit/v0.3.3/deno/fetch_bom.ts \
  --version=^0.1.0 \
